...
class MapperGraph:
    ...
    df = pd.read_csv(data_dir + 'dedup_data_sample.csv').drop(columns=['Unnamed: 0', 'level_0'])
    #print(df.shape)
    ...
    def __init__(self, data, n, projection, cover, clustering):
        ...
        noww = '14-04-2022_23:25:29' # best embeddings so far
        self.uids = np.load(data_dir + "embeddings/resnext-101_epoch_3" + noww + ".npy", allow_pickle=True)[:,0][0:n]
